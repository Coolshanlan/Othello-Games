...
namespace 黑白棋
{
    public partial class GameTree3_Othello : Form
    {
        public bool dowm = false;
        ...
        private void GameTree3_Othello_Load(object sender, EventArgs e)
        {
